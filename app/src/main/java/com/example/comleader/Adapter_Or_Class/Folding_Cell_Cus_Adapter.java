...
public class Folding_Cell_Cus_Adapter extends ArrayAdapter<Cus_Detail_Model> {
    ...
    public Folding_Cell_Cus_Adapter(Context context, ArrayList<Cus_Detail_Model> objects) {
...
//        cell.fold(true);
        ...
        if (cell == null) {
            ...
            LayoutInflater via = LayoutInflater.from(getContext());
            cell = (FoldingCell) via.inflate(R.layout.cus_fol_layout, parent, false);
