...
import com.example.commember.Adapter_Or_Class.CounteryData;
import com.example.commember.Adapter_Or_Class.OnSweepListner;
import com.example.commember.Modal.Users;
                        ...
                        if (userdata.getNumber().equals(Number)) {
                            ...
                            if (userdata.getPassward().equals(passward)) {
                                ...
                                if (parantName.equals("User")) {
                                    try {
                                        if(userdata.getSuspend().equals("Approved")){
                                            ...
                                            i.putExtra("eeee", "LA");
                                            startActivity(i);
                                        }else if(userdata.getSuspend().equals("Suspend")){
