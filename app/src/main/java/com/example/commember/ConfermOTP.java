...
public class ConfermOTP extends AppCompatActivity {
        ...
        try {
            ...
            mCallBack = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
                ...
                public void onVerificationCompleted(PhoneAuthCredential phoneAuthCredential) {
                    ...
                    if (code != null && !TextUtils.isEmpty(T)) {
                        editText.setText(code);
                        verifyCode(code, name, passward, phonenumber, T);
                    }
                }
            ...
            SignIn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    ConfermOTP.this.verifyCode(code, name, passward, phonenumber, r);
                }
            });
        } catch (Exception e) {
            Toast.makeText(ConfermOTP.this, e.getMessage(), Toast.LENGTH_LONG).show();
    ...
    private void verifyCode(String code, String Name, String Passward, String PhoneNumber, String r) {
        PhoneAuthCredential credential = PhoneAuthProvider.getCredential(verificationId, code);
        Toast.makeText(ConfermOTP.this, "verifyCode", Toast.LENGTH_LONG).show();
        signInWithCredential(credential, Name, PhoneNumber, Passward, r);
    }

    private void signInWithCredential(PhoneAuthCredential credential, final String NameF, final String PhoneNumberF, final String PasswardF, String r) {
        mAuth.signInWithCredential(credential)
                .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    @Override
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ConfermOTP.this.AddAccount(NameF, PhoneNumberF, PasswardF, r);
                        } else {
    ...
    private void AddAccount(String nameF, final String phoneNumberF, String passwardF, String r) {
        ...
        userdata.put("Address", r);
        userdata.put("Suspend", "A");
        userdata.put("Token", "A");
        userdata.put("Image", "A");
        userdata.put("Latitude", "A");
        userdata.put("Longitude", "A");
        userdata.put("OnCall", "False");
        userdata.put("Online", "Offline");
        userdata.put("Last Seen", "Off");
        userdata.put("Warning", "Off");
